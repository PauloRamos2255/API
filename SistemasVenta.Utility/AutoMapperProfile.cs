...
namespace SistemaVentas.Utility
{
    public class AutoMapperProfile : Profile
    {
        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<UsuarioDTO,Usuario >().ForMember(destino => destino.IdRolNavigation, opt => opt.Ignore()).
            ...
            #region Venta
            CreateMap<Venta, VentaDTO>().ForMember(destino =>
                destino.TotalTexto,
            ...
            CreateMap<VentaDTO, Venta>().ForMember(destino =>
               destino.Total,
